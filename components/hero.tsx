      ...
      <div className="max-w-[46rem]">
        ...
        */}
        ...
        {/*
          ...
          하나로 흘려두면 브라우저가 폭이 남는 대로 채워서 `믿습니다. AI 전환의`
          처럼 **한 줄에 두 문장이 걸친다.** 앞 문장이 끝난 걸 눈이 못 알아채고,
          위에 적어둔 [믿음 → 자격 → 약속] 세 칸이 통째로 뭉개진다.

          text-balance 는 각 문장 안에서 쓴다 — 두 줄로 접힐 때 한 줄이 길고
          한 줄이 단어 두 개만 남는 걸 막는다. 문장이 짧아 balance 가 잘 듣는다.
        ...
        */}
        <p className="text-ink-soft mt-6 max-w-[40rem] text-lg sm:text-xl">
          ...
          {/* \u00A0 = 줄바꿈 없는 공백. `직접 / 만들고` 처럼 한 덩어리로 읽히는
              말이 좁은 화면에서 갈리는 걸 막는다. keep-all 이 어절은 안 쪼개지만
              어절 **사이**는 어디서든 끊으므로, 붙여둘 짝은 이렇게 직접 묶는다.
              ⚠️ 남발하면 안 된다 — 묶은 덩어리가 화면 폭보다 길면 가로로 넘친다. */}
          <span className="block text-balance">
            AI 전환의 한가운데에서 직접{"\u00A0"}만들고, 사업하고, 생각합니다.
          </span>
          <span className="block text-balance">
            AX를 하는 사업자가 무엇을{"\u00A0"}보고, 무엇을{"\u00A0"}고민하며, 어디로{"\u00A0"}향하는지
            기록합니다.
          </span>
        </p>
