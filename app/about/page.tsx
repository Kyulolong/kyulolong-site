...
export const metadata: Metadata = pageMetadata({
  title: "소개",
  description:
    "삼성SDS 인사팀에서 일하다 창업하기까지. 사람과 조직을 어떻게 보게 됐는지 적어뒀습니다.",
  path: "/about",
});
 ...
 * → 존재의 가치 → 맺음("빈 화면 앞에서…").
 *
 * 2026-09-16 부분 개정 — 교육·코칭 쪽으로 방향을 잡으며 사실과 호명을 맞췄다.
 *   - 첫 문단: 청중 호명(창업을 고민하는 분 · 주니어)을 브랜드 핵심 질문으로 교체
 *     (docs/BRAND.md §2 "회사에서 일하면서 우리는 무엇을 배워야 하는가?").
 *   - 경력: 삼성SDS 해외인사팀 5년(37개국 채용 · 직무 분석 · 글로벌 인사 시스템),
 *     스타트업 2년. 직무 분석은 교육 서비스의 근거라 새로 적었다.
 *   - 부트캠프(2024)와 팀의 내력: 동료 둘은 부트캠프에서, 하나는 전 직장에서.
 *     ⚠️ 스타트업 영업총괄 이력은 사이트에 올리지 않기로 했다 (본인 결정).
 *   - metadata 에서 "코드 한 줄 못 짜다가"를 뺐다 — 부트캠프를 수료했으니 사실과 어긋난다.
 *
      ...
      <div className="mx-auto max-w-[46rem]">
        ...
        */}
        ...
        <div className="text-ink-soft space-y-6 pb-4 text-[1.0625rem]">
          <p>
            이 홈페이지는 회사에서 일하며 무엇을 배워야 하는지, 그 배움이 다음 일로 어떻게
            이어지는지 이야기하려고 만들었습니다.
          </p>

          <p>
            저는 10년 가까이 인사와 조직을 경험했습니다. 대기업 해외인사팀에서 5년 동안
            37개국의 채용을 운영하고, 직무를 분석하고, 글로벌 인사 시스템 도입을
            맡았습니다. 스타트업에서는 2년 동안 인사를 포함한 운영 전반을 맡았습니다.
          </p>
          ...
          <p>
            그때는 개발을 외주에 맡겼습니다. 그래서 다음에는 직접 개발을 배우고
            함께 만들 동료를 찾으려고, 앱 개발 부트캠프에 들어갔습니다.
          </p>

          <p>
            두 번째 창업은 그 부트캠프에서 시작했습니다. 그때의 동료 두명이 지금도 같은 팀입니다. 이후 전 직장 동료 한 명이 합류해
            지금은 넷이 일합니다. 처음에는 전혀 다른 서비스를 만들었지만, 서로의 의견을 듣고 바꾸는 과정에서 지금의{" "}
            <a
